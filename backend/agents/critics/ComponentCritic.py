...
class ComponentCritic:
    ...
    def __init__(self, window_size: int = 100):
        ...
        # Observation history
        self.selection_history = deque(maxlen=window_size)
        self.requirement_history = deque(maxlen=window_size)
        self.installation_history = deque(maxlen=window_size)
        self.component_ids_used = deque(maxlen=window_size)
        ...
        for comp in selected:
            ...
            for req_key, req_val in requirements.items():
                if req_key.startswith("min_"):
                    ...
                    # If component is 3x over requirement, flag as over-spec
                    if comp_val > req_val * 3:
    ...
    def analyze(self) -> Dict:
        ...
        return {
            ...
            "confidence": min(1.0, len(self.selection_history) / self.window_size)
        }
    ...
    def _detect_component_failure_modes(self,
        ...
        if diversity_score < 0.3 and len(self.component_ids_used) > 20:
    ...
    def _generate_component_recommendations(self,
        ...
        if installation_success_rate < 0.8:
